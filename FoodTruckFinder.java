...
public class FoodTruckFinder {
	...
	//ArrayList<ArrayList<String,String>> throws JsonIOException, JsonSyntaxException, IOException
	public static JsonArray getAPIData() throws IOException {

		String dayOfWeek = getDayOfWeek();
		//format JSON response to get desired
	...
	private static void printList() {
		...
		for(int i=0; i<foodTruckData.size(); i++){
			...
			counter++;
			//if we hit 10 visible food truck entries, wait for user input
			if(counter == 10){
				waitForUserInput();
				//clear screen
